...
| [[https://github.com/dennyzhang/kubernetes-yaml-templates/blob/master/pod/pod-environment-var.yaml][pod/pod-environment-var.yaml]]   | Start a pod of passing environment variables     |
